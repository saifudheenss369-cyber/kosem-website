...
export default function ShareButton({ title, text, url }) {
    ...
    return (
        <button
            ...
            onMouseOut={(e) => { e.currentTarget.style.borderColor = 'var(--color-border)'; e.currentTarget.style.background = 'var(--color-bg-secondary)'; }}
            title="Share this product"
        >
            {copied ? (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="var(--color-gold)" style={{ width: '20px', height: '20px' }}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
            ) : (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="var(--color-gold)" style={{ width: '20px', height: '20px' }}>
            ...
            <span style={{ color: copied ? 'var(--color-gold)' : 'var(--color-text-main)' }}>
