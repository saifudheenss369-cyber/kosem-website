...
export default function AdminCategories() {
    ...
    return (
        <div>
            ...
            <div style={{ background: 'white', padding: '1.5rem', borderRadius: '8px', marginBottom: '2rem', boxShadow: '0 2px 5px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '1.5rem' }}>
                {categories.map(cat => (
                    <div key={cat.id} style={{ background: 'white', borderRadius: '8px', overflow: 'hidden', border: '1px solid #eee', position: 'relative' }}>
                        <div style={{ height: '120px', background: '#f9f9f9', position: 'relative' }}>
                            {cat.image ?
                                <img src={cat.image} alt={cat.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                : <div style={{ display: 'grid', placeItems: 'center', height: '100%', color: '#ccc', fontSize: '2rem' }}>📦</div>
                            }
                        ...
                        <div style={{ padding: '1rem' }}>
                            ...
                            <p style={{ margin: 0, fontSize: '0.8rem', color: '#888' }}>/{cat.slug}</p>
                        </div>
                        <button
