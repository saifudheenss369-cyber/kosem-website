    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    <select
                        ...
                        style={{ padding: '0.6rem 1rem', borderRadius: '8px', border: '1px solid var(--color-border)', fontSize: '1rem', fontWeight: 'bold', background: 'var(--color-bg-secondary)', cursor: 'pointer', boxShadow: '0 2px 5px rgba(0,0,0,0.05)' }}
                    >
                    ...
                    <div style={{ background: 'var(--color-bg-secondary)', padding: '0.6rem 1rem', borderRadius: '8px', border: '1px solid var(--color-border)', fontSize: '0.9rem', color: 'var(--color-text-muted)', boxShadow: '0 2px 5px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
                ...
                {/* Orders Card */}
                <div className="stat-card" style={{ background: 'var(--color-bg-secondary)', padding: '2rem', borderRadius: '12px', border: '1px solid var(--color-border)', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', alignItems: 'start', marginBottom: '1rem' }}>
                        <div>
                            <p style={{ fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--color-text-muted)', marginBottom: '0.5rem' }}>Total Orders</p>
                            <h2 style={{ fontSize: '2rem', color: 'var(--color-black)' }}>{stats.orders}</h2>
                        </div>
                        <div style={{ background: 'var(--color-bg-secondary)', padding: '0.5rem', borderRadius: '8px' }}>📦</div>
                    </div>
                    <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>
                ...
                <div className="stat-card" style={{ background: 'var(--color-bg-secondary)', padding: '2rem', borderRadius: '12px', border: '1px solid var(--color-border)', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', alignItems: 'start', marginBottom: '1rem' }}>
                        <div>
                            <p style={{ fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--color-text-muted)', marginBottom: '0.5rem' }}>Total Customers</p>
                ...
                <div className="stat-card" style={{ background: 'var(--color-bg-secondary)', padding: '2rem', borderRadius: '12px', border: '1px solid var(--color-border)', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', alignItems: 'start', marginBottom: '1rem' }}>
                        <div>
                            <p style={{ fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--color-text-muted)', marginBottom: '0.5rem' }}>Products</p>
            ...
            <div style={{ position: 'relative', opacity: isLoading ? 0.5 : 1, transition: 'opacity 0.3s' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '2rem' }}>
                    ...
                    <div style={{ background: 'var(--color-bg-secondary)', padding: '2rem', borderRadius: '12px', border: '1px solid var(--color-border)', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
                        <h3 style={{ marginBottom: '1.5rem', fontFamily: 'var(--font-serif)', fontSize: '1.25rem', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem' }}>
                            ...
                            <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', fontWeight: 'normal', fontFamily: 'sans-serif' }}>By Quantity</span>
                        </h3>
                                ...
                                {stats.topItems.map((item, i) => (
                                    <div key={i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', borderBottom: i !== stats.topItems.length - 1 ? '1px solid #f5f5f5' : 'none', paddingBottom: '0.5rem' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                            ...
                                            <strong style={{ color: 'var(--color-text-main)', fontSize: '0.95rem' }}>{item.name}</strong>
                                        </div>
                                        <div style={{ textAlign: 'right' }}>
                                            <div style={{ fontWeight: 'bold', color: 'var(--color-black)' }}>{item.quantity} units</div>
                                            <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>₹{(item.revenue || 0).toLocaleString()}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ) : (
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '200px', color: 'var(--color-text-muted)', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ background: 'var(--color-bg-secondary)', padding: '2rem', borderRadius: '12px', border: '1px solid var(--color-border)', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
                        <h3 style={{ marginBottom: '2rem', fontFamily: 'var(--font-serif)', fontSize: '1.25rem', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem' }}>
                            Top Categories
                            <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', fontWeight: 'normal', fontFamily: 'sans-serif' }}>By Revenue</span>
                        </h3>
                                ...
                                {stats.categoryData.map((cat, i) => (
                                    <div key={i}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem', fontSize: '0.9rem' }}>
                                            ...
                                            <span style={{ color: 'var(--color-text-muted)', fontWeight: 'bold' }}>₹{cat.value.toLocaleString()}</span>
                                        </div>
                                        <div style={{ width: '100%', height: '8px', background: 'var(--color-bg-secondary)', borderRadius: '10px', overflow: 'hidden' }}>
                                            <div style={{
