            ...
            <main style={{ flex: 1, paddingTop: '100px' }}>
                ...
                <section style={{ background: 'var(--color-black)', color: 'white', padding: '6rem 2rem', textAlign: 'center' }}>
                    <div className="container">
                        ...
                        <p style={{ fontSize: '1.2rem', maxWidth: '700px', margin: '0 auto', color: '#ccc', lineHeight: '1.8' }}>
                ...
                <div className="container" style={{ maxWidth: '900px', padding: '4rem 1.5rem' }}>
                    ...
                    <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', marginBottom: '4rem' }}>
                        <div style={{ background: 'white', padding: '3rem 2rem', borderRadius: '12px', boxShadow: '0 10px 40px rgba(0,0,0,0.05)', textAlign: 'center', borderTop: '4px solid var(--color-gold)' }}>
                        ...
                        <div style={{ background: 'white', padding: '3rem 2rem', borderRadius: '12px', boxShadow: '0 10px 40px rgba(0,0,0,0.05)', textAlign: 'center', borderTop: '4px solid var(--color-black)' }}>
                    ...
                    {/* Why Choose Us */}
                    <section style={{ marginBottom: '4rem', background: '#fff', padding: '4rem 2rem', borderRadius: '12px', boxShadow: '0 5px 20px rgba(0,0,0,0.03)' }}>
                        ...
                        <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: '1.5rem' }}>
                            <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                                ...
                                <div>
                                    ...
                                    <span style={{ color: '#555', lineHeight: '1.6' }}>We specialize in concentrated perfume oils that respect your skin and adhere strictly to faith-based purity standards.</span>
                                </div>
                            </li>
                            <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                                <span style={{ color: 'var(--color-gold)', fontSize: '1.5rem' }}>✦</span>
                                <div>
                                    ...
                                    <span style={{ color: '#555', lineHeight: '1.6' }}>Every attar is richly formulated so that a single application envelopes you in a captivating aura all day long.</span>
                                </div>
                            </li>
                            <li style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                                <span style={{ color: 'var(--color-gold)', fontSize: '1.5rem' }}>✦</span>
                                <div>
                                    ...
                                    <span style={{ color: '#555', lineHeight: '1.6' }}>We never compromise. Each composition features the finest selected elements—from rare oudhs to breathtaking florals.</span>
                                </div>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        ...
                        <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#555', padding: '0 1rem' }}>
                    ...
                    <section style={{ background: 'var(--color-black)', color: 'white', padding: '4rem 3rem', borderRadius: '12px', textAlign: 'center', position: 'relative' }}>
                        ...
                        <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#ccc', fontStyle: 'italic', marginBottom: '2rem' }}>
